...
|     |                   |If the solution-system has added functions, such as in dashboards and data analytics, it would further provide multitudes of insight-knowledge to groups-in-needs.||
| 3.  |                   |||
