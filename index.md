...
|        |ii.	 When use of keyword such as “rpa” returns gibberish; and|Could return such item as “ca<span style="color: red;">rpa</span>rk”, hence added “..” to all search item. Some Markdown text with <span style="color:blue">some *blue* text</span>|
