...
|        |iii.	iii.	Keyword returning items with “Corrigendum”, publish of “corrected info” – hence upsetting consistency of display table/s (throw workflow on runtime error;|This is part of GeBIZ in handling publish- “corrected info”, but may be resolve in using different scraping techniques.|
...
|C. Technical |UiPath-Studio|It was good to have team members with already background and/or interest in “programming” for team to resolve technical issues.|
|             |GeBIZ website|Need more time and work in this domain.|
